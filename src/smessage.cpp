// Copyright (c) 2014 The viorcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("viorcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("viorcoin-smsg-pow"); // Make this thread recognisable
