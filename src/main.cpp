...
const string strMessageMagic = "viorcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "viorcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        block.nVersion = 1;
        block.nTime    = 1413662459;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 519110 : 519110;
       ...
       printf("block.nNonce = %u \n", block.nNonce);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xdd3f5a5d1ec65b53c84906dd80128408fd783c39e0641e18498e0a4c848f827d"));
        block.print();
